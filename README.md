#Program-1 To check the given arrays are equal or not.

#Program-2 To check the given string values are ANAGRAM or not

#program-3 To check the sum of even numbers divisible by 3

#program-4 sum of numbers divisible by 3

#program-5: Micro and Array Update
...
Constraints: 1<=T<=5 1<=N<=10^5 1<=A[i],K<=10^6

SAMPLE INPUT 2 3 4 1 2 5 3 2 2 5 5 SAMPLE OUTPUT 3 0

#Program-6: Hamilitonian and lagrangian
...
SAMPLE INPUT 6 16 17 4 3 5 2 SAMPLE OUTPUT 17 5 2

#program-7: Pink floyd and happiness
...
SAMPLE INPUT 5 1 2 4 3 5 SAMPLE OUTPUT Happy

#program-8: Frustrated coders
...
SAMPLE INPUT 6 1 7 2 2 4 4 SAMPLE OUTPUT 11
